...
from models.net_utils import run_lstm, col_tab_name_encode, encode_question, SIZE_CHECK, plain_conditional_weighted_num
...
class HavingPredictor(nn.Module):
    def __init__(self, N_word, N_h, N_depth, gpu, use_hs, bert=None):
        ...
        self.hv_out_q = nn.Linear(encoded_num, N_h)
